...
class Deployer {
    ...
    deployAndVerify(platform, contract, libraries, ...args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const deploymentArguments = Array.prototype.slice.call(args);
            const { contractCopy, transaction, transactionReceipt, deploymentResult } = yield this._prepareAndDeployTransaction(contract, libraries, deploymentArguments);
            const verification = yield Verifier.verifySmartContract(platform, deploymentResult, deploymentArguments, libraries, this.defaultOverrides);
    ...
    _generateDeploymentResult(contract, transaction, transactionReceipt) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new deployed_contract_wrapper_1.default(contract, transactionReceipt.contractAddress, this.signer, this.provider, transactionReceipt);
        });
    }
    /**
     *
